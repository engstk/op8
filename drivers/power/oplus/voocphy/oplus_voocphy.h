...
#define VOOC2_CIRCUIT_R_L_DEF                                                                                          \
	((R_DET_BIT5 << TX0_DET_BIT2_SHIFT) | (R_DET_BIT6 << TX0_DET_BIT3_SHIFT) | (R_DET_BIT7 << TX0_DET_BIT4_SHIFT))
#define NO_VOOC2_CIRCUIT_R_H_DEF ((R_DET_BIT9 << TX1_DET_BIT1_SHIFT) | (R_DET_BIT8 << TX1_DET_BIT0_SHIFT))
#define NO_VOOC2_CIRCUIT_R_L_DEF                                                                                       \
	((R_DET_BIT4 << TX0_DET_BIT1_SHIFT) | (R_DET_BIT5 << TX0_DET_BIT2_SHIFT) |                                     \
	 (R_DET_BIT6 << TX0_DET_BIT3_SHIFT) | (R_DET_BIT7 << TX0_DET_BIT4_SHIFT))
#define BIDRECT_CIRCUIT_R_L_DEF                                                                                        \
	((R_DET_BIT5 << TX0_DET_BIT2_SHIFT) | (R_DET_BIT6 << TX0_DET_BIT3_SHIFT) | (R_DET_BIT7 << TX0_DET_BIT4_SHIFT))
#define BURR_VOOC2_CIRCUIT_R                                                                                           \
	((R_DET_BIT4 << 4) | (R_DET_BIT5 << 3) | (R_DET_BIT6 << 2) | (R_DET_BIT7 << 1) | (R_DET_BIT8))
...
#define NO_VOOC3_CIRCUIT_R_H_DEF                                                                                       \
	((R_DET_BIT_VOOC30_9 << TX1_DET_BIT1_SHIFT) | (R_DET_BIT_VOOC30_8 << TX1_DET_BIT0_SHIFT))
#define NO_VOOC3_CIRCUIT_R_L_DEF                                                                                       \
	((R_DET_BIT_VOOC30_4 << TX0_DET_BIT1_SHIFT) | (R_DET_BIT_VOOC30_5 << TX0_DET_BIT2_SHIFT) |                     \
...
#define VOOC2_CIRCUIT_PARALLEL_R_H_DEF                                                                                 \
	((R_DET_PARALLEL_BIT9 << TX1_DET_BIT1_SHIFT) | (R_DET_PARALLEL_BIT8 << TX1_DET_BIT0_SHIFT))
#define VOOC2_CIRCUIT_PARALLEL_R_L_DEF                                                                                 \
	((R_DET_PARALLEL_BIT5 << TX0_DET_BIT2_SHIFT) | (R_DET_PARALLEL_BIT6 << TX0_DET_BIT3_SHIFT) |                   \
	 (R_DET_PARALLEL_BIT7 << TX0_DET_BIT4_SHIFT))
#define NO_VOOC2_CIRCUIT_PARALLEL_R_H_DEF                                                                              \
	((R_DET_PARALLEL_BIT9 << TX1_DET_BIT1_SHIFT) | (R_DET_PARALLEL_BIT8 << TX1_DET_BIT0_SHIFT))
#define NO_VOOC2_CIRCUIT_PARALLEL_R_L_DEF                                                                              \
	((R_DET_PARALLEL_BIT4 << TX0_DET_BIT1_SHIFT) | (R_DET_PARALLEL_BIT5 << TX0_DET_BIT2_SHIFT) |                   \
	 (R_DET_PARALLEL_BIT6 << TX0_DET_BIT3_SHIFT) | (R_DET_PARALLEL_BIT7 << TX0_DET_BIT4_SHIFT))
#define BURR_VOOC2_CIRCUIT_PARALLEL_R                                                                                  \
	((R_DET_PARALLEL_BIT4 << 4) | (R_DET_PARALLEL_BIT5 << 3) | (R_DET_PARALLEL_BIT6 << 2) |                        \
...
#define NO_VOOC3_CIRCUIT_PARALLEL_R_H_DEF                                                                              \
	((R_DET_PARALLEL_BIT_VOOC30_9 << TX1_DET_BIT1_SHIFT) | (R_DET_PARALLEL_BIT_VOOC30_8 << TX1_DET_BIT0_SHIFT))
#define NO_VOOC3_CIRCUIT_PARALLEL_R_L_DEF                                                                              \
	((R_DET_PARALLEL_BIT_VOOC30_4 << TX0_DET_BIT1_SHIFT) | (R_DET_PARALLEL_BIT_VOOC30_5 << TX0_DET_BIT2_SHIFT) |   \
