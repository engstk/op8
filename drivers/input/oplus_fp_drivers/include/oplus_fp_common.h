...
#define FP_ID_MAX_LENGTH \
	60 /*the length of /proc/fp_id should less than FP_ID_MAX_LENGTH !!!*/
...
#define FP_POWER_NODE \
	"power-mode" /* 0: power mode not set, 1: ldo power, 2: gpio power, 3: auto power */
