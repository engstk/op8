...
#define PANEL_IOCTL_GET_SERIAL_NUMBER \
	PANEL_IOWR(0x0E, struct panel_serial_number)
...
#define PANEL_IOCTL_GET_DISPLAY_TIMING_INFO \
	PANEL_IOWR(0x16, struct display_timing_info)
...
#define PANEL_IOCTL_SET_APOLLO_BACKLIGHT \
	PANEL_IOW(0x51, struct apollo_backlight_map_value)
