...
#define SKIP_DUMMY_END           28 // TX+SKIP_NOTCH_END
    ...
    uint8_t ovl_idx[ovl_section_num] ={10,11,12};
    const struct firmware *g_fw_entry = NULL;
#endif
...
struct chip_data_hx83102d {
    uint32_t *p_tp_fw;
    tp_dev tp_type;
    char   *test_limit_name;
    struct himax_proc_operations *syna_ops; /*hx83102d func provide to hx83102d common driver*/
