...
#ifndef __QCOM_PLATFORM_TRINKET_H__
#define __QCOM_PLATFORM_TRINKET_H__

#include "oplus_wakelock_profiler.h"

static struct wakeup_count_desc_t wc_powerkey_trinket = {
...
static struct wakeup_count_desc_t wc_rtc_alarm_trinket = {
...
static struct wakeup_count_desc_t wc_alarm_trinket = {
	.module_name = "alarm",
...
static struct wakeup_count_desc_t wc_modem_trinket = {
	.module_name = "modem",
...
static struct wakeup_count_desc_t wc_wlan_trinket = {
	.module_name = "wlan",
...
static struct wakeup_count_desc_t wc_adsp_trinket = {
	.module_name = "adsp",
...
static struct wakeup_count_desc_t wc_cdsp_trinket = {
	.module_name = "cdsp",
...
static struct wakeup_count_desc_t wc_slpi_trinket = {
	.module_name = "slpi",
...
static struct wakeup_count_desc_t wc_glink_trinket = {
...
static struct wakeup_count_desc_t wc_abort_trinket = {
...
static struct wakeup_count_desc_t wc_sum_trinket = {
 ...
 */
static struct wakeup_count_desc_t * const all_modules_trinket[] = {
	&wc_powerkey_trinket,
	&wc_rtc_alarm_trinket,
	&wc_alarm_trinket,
	&wc_modem_trinket,
	&wc_wlan_trinket,
	&wc_adsp_trinket,
 ...
 */
static const char* const modem_report_exchange_trinket[][MODEM_REPORT_NUMBER] = {
	{IRQ_NAME_MODEM_IPA, IRQ_NAME_MODEM_QMI},
	{NULL, NULL},
};

#endif /*__QCOM_PLATFORM_TRINKET_H__*/