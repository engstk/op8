...
int read_chg_strategy_data_from_node(struct device_node *node, const char *prop_str,
				     struct oplus_chg_strategy_data *ranges);
int oplus_chg_get_chg_strategy_data_len(struct oplus_chg_strategy_data data[], int max_len);
void oplus_chg_strategy_init(struct oplus_chg_strategy *strategy, struct oplus_chg_strategy_data *data, int data_size,
			     int temp);
int oplus_chg_strategy_get_data(struct oplus_chg_strategy *strategy, struct oplus_chg_strategy_temp_region *temp_region,
				int temp);
