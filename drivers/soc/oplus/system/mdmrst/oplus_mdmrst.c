...
static unsigned int mdmreason_poll(struct file *file,
...
static ssize_t mdmreason_read(struct file *file, char __user *buf, size_t count,
			      loff_t *ppos)
{
	size_t size = 0;
...
static struct miscdevice mdmreason_device = { MISC_DYNAMIC_MINOR, "mdmreason",
					      &mdmreason_device_fops };
...
ssize_t mdmrst_read(struct file *file, char __user *buf, size_t count,
		    loff_t *ppos)
{
	char *tmp = "1";
...
static struct miscdevice mdmrst_device = { MISC_DYNAMIC_MINOR, "mdmrst",
					   &mdmrst_device_fops };
