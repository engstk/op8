...
#ifndef __QCOM_PLATFORM_HOLI_H__
#define __QCOM_PLATFORM_HOLI_H__

#include "oplus_wakelock_profiler.h"

static struct wakeup_count_desc_t wc_powerkey_holi = {
...
static struct wakeup_count_desc_t wc_rtc_alarm_holi = {
...
static struct wakeup_count_desc_t wc_modem_holi = {
	.module_name = "modem",
...
static struct wakeup_count_desc_t wc_wlan_holi = {
	.module_name = "wlan",
...
static struct wakeup_count_desc_t wc_adsp_holi = {
	.module_name = "adsp",
...
static struct wakeup_count_desc_t wc_cdsp_holi = {
	.module_name = "cdsp",
...
static struct wakeup_count_desc_t wc_slpi_holi = {
	.module_name = "slpi",
...
static struct wakeup_count_desc_t wc_glink_holi = {
...
static struct wakeup_count_desc_t wc_abort_holi = {
...
static struct wakeup_count_desc_t wc_sum_holi = {
 ...
 */
static struct wakeup_count_desc_t * const all_modules_holi[] = {
	&wc_powerkey_holi,
	&wc_rtc_alarm_holi,
	/*&wc_alarm_holi,*/
	&wc_modem_holi,
 ...
 */
static const char * const modem_report_exchange_holi[][MODEM_REPORT_NUMBER] = {
	{IRQ_NAME_MODEM_IPA, IRQ_NAME_MODEM_QMI},
	{NULL, NULL},
};

#endif /*__QCOM_PLATFORM_HOLI_H__*/
