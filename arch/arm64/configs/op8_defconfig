...
# Linux/arm64 4.19.322 Kernel Configuration
#
CONFIG_OPLUS_SYSTEM_KERNEL_QCOM=y
# CONFIG_OPLUS_SYSTEM_KERNEL_MTK is not set
CONFIG_OPLUS_SLUB_TEST=""
CONFIG_OPLUS_KASAN_TEST=""
CONFIG_OPLUS_KMEMLEAK_TEST=""
CONFIG_OPLUS_AGING_TEST=""
CONFIG_OPLUS_PAGEOWNER_TEST=""
# CONFIG_OPLUS_AGING_DEBUG is not set
# CONFIG_OPLUS_KASAN_DEBUG is not set
# CONFIG_OPLUS_KMEMLEAK_DEBUG is not set
# CONFIG_OPLUS_SLUB_DEBUG is not set
# CONFIG_OPLUS_PAGEOWNER_DEBUG is not set
...
# CONFIG_OPLUS_FEATURE_SCHED_SPREAD is not set
# CONFIG_OPLUS_UX_IM_FLAG is not set
# CONFIG_OPLUS_RELEASE_BUFFER_CALLBACK_UX is not set
CONFIG_OPLUS_FEATURE_AUDIO_OPT=y
# CONFIG_OPLUS_CRTC_COMMIT_MUTEX_OPT is not set
...
# CONFIG_ARM_QCOM_CPUFREQ_HW_DEBUG is not set
...
# CONFIG_OPLUS_MEMORY_ISOLATE is not set
...
CONFIG_BTFM_SLIM=y
# CONFIG_BTFM_SLIM_WCN3990 is not set
...
# CONFIG_OPLUS_FEATURE_QR_SCAN is not set
...
CONFIG_VSERVICES_BLOCK_SERVER=y
CONFIG_VSERVICES_BLOCK_CLIENT=y
...
# CONFIG_OKL4_RINGBUF is not set
...
# qrc device driver
#
# CONFIG_QRC is not set
# CONFIG_OKL4_USER_VIPC is not set
CONFIG_OKL4_LINK_SHBUF=y
...
# CONFIG_OPLUS_SECURE_MTK is not set
# CONFIG_QCOM_QSEELOG_ENCRYPT is not set
...
# CONFIG_MSM_FASTCVPD is not set
CONFIG_MSM_ADSPRPC=y
# CONFIG_ADSPRPC_DEBUG is not set
CONFIG_MSM_RDBG=m
# CONFIG_RB5_FAN_CONTROLLER is not set
# CONFIG_RB5_GPIOS_ENABLE is not set
CONFIG_RANDOM_TRUST_BOOTLOADER=y
CONFIG_OKL4_PIPE=y
CONFIG_VSERVICES_SERIAL=y
CONFIG_VSERVICES_SERIAL_SERVER=y
CONFIG_VSERVICES_SERIAL_CLIENT=y
CONFIG_VSERVICES_VTTY_COUNT=8
...
# CONFIG_PINCTRL_MSM8937 is not set
...
# CONFIG_PINCTRL_LITO is not set
# CONFIG_PINCTRL_LAGOON is not set
...
# CONFIG_OPLUS_QPNP_QG is not set
# CONFIG_HL6111R is not set
# CONFIG_SMB1398_CHARGER is not set
CONFIG_OPLUS_SM8250_CHARGER=y
# CONFIG_OPLUS_SM7250R_CHARGER is not set
# CONFIG_OPLUS_CHARGER_OPTIGA is not set
...
# CONFIG_QTI_AOP_REG_COOLING_DEVICE is not set
...
# CONFIG_QTI_THERMAL_QFPROM is not set
...
# CONFIG_USB_VBUS_EXTCON_GENOA is not set
...
# CONFIG_LEDS_QPNP_VIBRATOR is not set
...
#
CONFIG_VSERVICES_SUPPORT=y
CONFIG_VSERVICES_CHAR_DEV=y
# CONFIG_VSERVICES_DEBUG is not set
CONFIG_VSERVICES_LOCK_DEBUG=y
CONFIG_VSERVICES_SERVER=y
CONFIG_VSERVICES_CLIENT=y
# CONFIG_VSERVICES_SKELETON_DRIVER is not set
# CONFIG_VSERVICES_NAMED_DEVICE is not set

#
# Transport drivers
#
CONFIG_VSERVICES_OKL4_AXON=y

#
# Protocol drivers
#
CONFIG_VSERVICES_PROTOCOL_BLOCK=y
CONFIG_VSERVICES_PROTOCOL_BLOCK_SERVER=y
CONFIG_VSERVICES_PROTOCOL_BLOCK_CLIENT=y
CONFIG_VSERVICES_PROTOCOL_SERIAL=y
CONFIG_VSERVICES_PROTOCOL_SERIAL_SERVER=y
CONFIG_VSERVICES_PROTOCOL_SERIAL_CLIENT=y
...
# CONFIG_SM_GCC_LITO is not set
# CONFIG_SM_VIDEOCC_LITO is not set
# CONFIG_SM_CAMCC_LITO is not set
# CONFIG_SM_DISPCC_LITO is not set
# CONFIG_SM_GPUCC_LITO is not set
# CONFIG_SM_NPUCC_LITO is not set
# CONFIG_SM_DEBUGCC_LITO is not set
...
# CONFIG_SDM_CAMCC_LAGOON is not set
# CONFIG_SDM_DEBUGCC_LAGOON is not set
# CONFIG_SDM_DISPCC_LAGOON is not set
# CONFIG_SDM_GCC_LAGOON is not set
# CONFIG_SDM_GPUCC_LAGOON is not set
# CONFIG_SDM_NPUCC_LAGOON is not set
# CONFIG_SDM_VIDEOCC_LAGOON is not set
...
# CONFIG_QCOM_LITO_LLCC is not set
# CONFIG_QCOM_LAGOON_LLCC is not set
...
CONFIG_RMNET_CTL=y
# CONFIG_RMNET_CTL_DEBUG is not set
...
CONFIG_RPMH_MODEM_SLEEPINFO_BUFFER=y
...
# CONFIG_QCOM_HYP_CORE_CTL is not set
...
# CONFIG_OPLUS_GPIO_NC is not set
CONFIG_OPLUS_FEATURE_LOWMEM_DBG=y
CONFIG_OPLUS_FEATURE_MIDAS=y
CONFIG_OPLUS_FEATURE_BINDER_STATS_ENABLE=y
# CONFIG_OPLUS_FEATURE_SET_ALL_VPU_LATENCY is not set
# CONFIG_OPLUS_FEATURE_DISPCAP is not set
CONFIG_SVELTE=y
CONFIG_HORAE_THERMAL_SHELL=y
# CONFIG_OPLUS_FEATURE_GKI_CPUFREQ_BOUNCING is not set
# CONFIG_OPLUS_FEATURE_ATD is not set
CONFIG_IOMONITOR=y
# CONFIG_IOMONITOR_WITH_F2FS is not set
CONFIG_OPLUS_SYSTEM_KERNEL=y
CONFIG_OPLUS_ARCH_FILE=y
# CONFIG_OPLUS_BUG_STABILITY_EFFECTON_QGKI is not set
# CONFIG_OPLUS_FEATURE_DETAILHEAD is not set
...
# CONFIG_OPLUS_FEATURE_ANDROIDBOOT is not set
# CONFIG_OPLUS_FEATURE_FTMMODE is not set
# CONFIG_OPLUS_FEATURE_CHARGERPRESENT is not set
# CONFIG_OPLUS_FEATURE_BUILDVARIANT is not set
# CONFIG_OPLUS_FEATURE_SIMCARDNUM is not set
# CONFIG_OPLUS_FEATURE_CDT is not set
...
# CONFIG_OPLUS_FEATURE_DUMP_REASON is not set
CONFIG_OPLUS_FEATURE_MM_FEEDBACK=y
# CONFIG_OPLUS_FEATURE_QCOM_WATCHDOG is not set
...
CONFIG_OPLUS_FEATURE_SELINUX_CONTROL_LOG=y
# CONFIG_OPLUS_FEATURE_MISC is not set
# CONFIG_PARAM_READ_WRITE is not set
# CONFIG_BOOTLOADER_LOG is not set
...
# CONFIG_OPLUS_POWER_QCOM is not set
# CONFIG_OPLUS_POWER_MTK is not set
# CONFIG_OPLUS_POWERINFO_STANDBY_DEBUG is not set
# CONFIG_OPLUS_POWERINFO_RPMH is not set
# CONFIG_OPLUS_POWERINFO_FTM is not set
...
# CONFIG_NANDSWAP is not set
# CONFIG_NANDSWAP_DEBUG is not set
...
# CONFIG_ARM_GIC_V3_ACL is not set
...
# CONFIG_OPLUS_BINDER_STRATEGY is not set
...
# CONFIG_OPLUS_FEATURE_EXT4_ASYNC_DISCARD is not set
# CONFIG_EXT4_DEBUG is not set
# CONFIG_OPLUS_FEATURE_EXT4_FRAGMENT is not set
# CONFIG_OPLUS_FEATURE_EXT4_FSYNC is not set
CONFIG_JBD2=y
...
# CONFIG_ENABLE_LEGACY_PFK is not set
CONFIG_FS_VERITY=y
...
# CONFIG_UTILS_MONITOR is not set
# CONFIG_OPLUS_GPU_FREQ_TRACE_POINT is not set
