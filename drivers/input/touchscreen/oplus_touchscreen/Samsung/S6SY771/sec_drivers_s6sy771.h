...
#ifndef SEC_H_S6SY771
#define SEC_H_S6SY771
...
#define SEC_STATUS_PAGE_ERASE 0x71
#define SEC_STATUS_SECTOR_ERASE 0x72
#define SEC_STATUS_WORD_WRITE 0x73
#define SEC_STATUS_PAGE_WRITE 0x74
#define SEC_STATUS_UPDATE_ADDR 0x75
#define SEC_STATUS_UPDATE_SIZE 0x76
...
//calibration status
#define SEC_VENDOR_INFO_CALIBRATION_STATUS 0x1F
...
#define SEC_READ_TOUCH_SETLEN_RAWDATA \
	0x74 //read out self define length rawdata(ordered by TX len)
...
#define SEC_CMD_SMOOTH_LEVEL 0x90
...
enum {
	...
	TYPE_INVALID_DATA =
		0xFF, /* Invalid data type for release factory mode */
};
...
#define NORMAL_CHARGER 0x01
#define WIRELESS_CHARGER 0x02

struct chip_data_s6sy771 {
	tp_dev tp_type;
