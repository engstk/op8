...
#ifndef __QCOM_PLATFORM_BENGAL_H__
#define __QCOM_PLATFORM_BENGAL_H__

#include "oplus_wakelock_profiler.h"

static struct wakeup_count_desc_t wc_powerkey_bengal = {
...
static struct wakeup_count_desc_t wc_rtc_alarm_bengal = {
...
static struct wakeup_count_desc_t wc_modem_bengal = {
	.module_name = "modem",
...
static struct wakeup_count_desc_t wc_wlan_bengal = {
	.module_name = "wlan",
...
static struct wakeup_count_desc_t wc_adsp_bengal = {
	.module_name = "adsp",
...
static struct wakeup_count_desc_t wc_cdsp_bengal = {
	.module_name = "cdsp",
...
static struct wakeup_count_desc_t wc_slpi_bengal = {
	.module_name = "slpi",
...
static struct wakeup_count_desc_t wc_glink_bengal = {
...
static struct wakeup_count_desc_t wc_abort_bengal = {
...
static struct wakeup_count_desc_t wc_sum_bengal = {
 ...
 */
static struct wakeup_count_desc_t * const all_modules_bengal[] = {
	&wc_powerkey_bengal,
	&wc_rtc_alarm_bengal,
	/*&wc_alarm_bengal,*/
	&wc_modem_bengal,
 ...
 */
static const char * const modem_report_exchange_bengal[][MODEM_REPORT_NUMBER] = {
	{IRQ_NAME_MODEM_IPA, IRQ_NAME_MODEM_QMI},
	{NULL, NULL},
};

#endif /*__QCOM_PLATFORM_BENGAL_H__*/
