...
struct vooc_charge_strategy *g_vooc_charge_strategy_p[OPLUS_FASTCHG_OUTPUT_POWER_MAX] = { NULL, NULL, NULL, NULL,
											  NULL };
...
static struct oplus_chg_debug_notify_policy oplus_chg_debug_notify_policy[] = {
	...
	[OPLUS_NOTIFY_CHG_UNSUSPEND] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					 "UnSuspendPlatPmic" }, /*add for unsuspend platPmic*/
	...
	[OPLUS_NOTIFY_WIRELESS_BOOTUP] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
					   "WirelessBootUp" }, /*add for wireless chg start*/
	...
	[OPLUS_NOTIFY_WIRELESS_WIRELESS_CHG_END] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
						     "WirelessEndChg" }, /*add for wireless chg end*/
	[OPLUS_NOTIFY_WIRELESS_START_TX] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1 },
	[OPLUS_NOTIFY_WIRELESS_STOP_TX] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1 },
	[OPLUS_NOTIFY_BCC_ANODE_POTENTIAL_OVER_TIME] = { OPLUS_CHG_NOTIFY_REPEAT, 1, 1, -1,
							 "BccAnodePotentialOverTime" },
...
static struct vooc_adapter_name vooc_adapter_name[] = {
	[OPLUS_FASTCHG_OUTPUT_POWER_20W] = { "VOOC_20W" },  [OPLUS_FASTCHG_OUTPUT_POWER_30W] = { "VOOC_30W" },
	[OPLUS_FASTCHG_OUTPUT_POWER_33W] = { "VOOC_33W" },  [OPLUS_FASTCHG_OUTPUT_POWER_50W] = { "SVOOC_50W" },
	[OPLUS_FASTCHG_OUTPUT_POWER_65W] = { "SVOOC_65W" },
};

struct vooc_charger_type vooc_charger_type_list[] = {
	{ 0x01, 5000, 4000, OPLUS_FASTCHG_OUTPUT_POWER_20W },  { 0x13, 5000, 4000, OPLUS_FASTCHG_OUTPUT_POWER_20W },
	{ 0x34, 5000, 4000, OPLUS_FASTCHG_OUTPUT_POWER_20W },

	{ 0x19, 5000, 6000, OPLUS_FASTCHG_OUTPUT_POWER_30W },  { 0x29, 5000, 6000, OPLUS_FASTCHG_OUTPUT_POWER_30W },
	{ 0x41, 5000, 6000, OPLUS_FASTCHG_OUTPUT_POWER_30W },  { 0x42, 5000, 6000, OPLUS_FASTCHG_OUTPUT_POWER_30W },
	{ 0x43, 5000, 6000, OPLUS_FASTCHG_OUTPUT_POWER_30W },  { 0x44, 5000, 6000, OPLUS_FASTCHG_OUTPUT_POWER_30W },
	{ 0x45, 5000, 6000, OPLUS_FASTCHG_OUTPUT_POWER_30W },  { 0x46, 5000, 6000, OPLUS_FASTCHG_OUTPUT_POWER_30W },

	{ 0x61, 11000, 3000, OPLUS_FASTCHG_OUTPUT_POWER_33W }, { 0x49, 11000, 3000, OPLUS_FASTCHG_OUTPUT_POWER_33W },
	{ 0x4A, 11000, 3000, OPLUS_FASTCHG_OUTPUT_POWER_33W }, { 0x4B, 11000, 3000, OPLUS_FASTCHG_OUTPUT_POWER_33W },
	{ 0x4C, 11000, 3000, OPLUS_FASTCHG_OUTPUT_POWER_33W }, { 0x4D, 11000, 3000, OPLUS_FASTCHG_OUTPUT_POWER_33W },
	{ 0x4E, 11000, 3000, OPLUS_FASTCHG_OUTPUT_POWER_33W },

	{ 0x11, 10000, 5000, OPLUS_FASTCHG_OUTPUT_POWER_50W }, { 0x12, 10000, 5000, OPLUS_FASTCHG_OUTPUT_POWER_50W },
	{ 0x21, 10000, 5000, OPLUS_FASTCHG_OUTPUT_POWER_50W }, { 0x31, 10000, 5000, OPLUS_FASTCHG_OUTPUT_POWER_50W },
	{ 0x33, 10000, 5000, OPLUS_FASTCHG_OUTPUT_POWER_50W }, { 0x62, 10000, 5000, OPLUS_FASTCHG_OUTPUT_POWER_50W },

	{ 0x14, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W }, { 0x32, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W },
	{ 0x35, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W }, { 0x36, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W },
	{ 0x63, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W }, { 0x64, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W },
	{ 0x65, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W }, { 0x66, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W },
	{ 0x69, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W }, { 0x6A, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W },
	{ 0x6B, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W }, { 0x6C, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W },
	{ 0x6D, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W }, { 0x6E, 10000, 6500, OPLUS_FASTCHG_OUTPUT_POWER_65W },
};
...
#if defined(CONFIG_OPLUS_HVDCP_SUPPORT) || defined(CONFIG_OPLUS_CHARGER_MTK6785) || !defined(CONFIG_OPLUS_CHARGER_MTK)
	[POWER_SUPPLY_TYPE_USB_HVDCP] = { "HVDCP" }, //mtk hvdcp
	[POWER_SUPPLY_TYPE_USB_HVDCP_3] = { "HVDCP_3" },
#endif
#if ((LINUX_VERSION_CODE >= KERNEL_VERSION(4, 14, 0)) && (!defined(CONFIG_OPLUS_CHARGER_MTK))) ||                      \
	((LINUX_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)) && defined(CONFIG_OPLUS_CHARGER_MTK))
...
static int oplus_chg_percent_cnt(int index)
{
	...
	pct = oplus_chg_debug_info.chg_cnt[index] * 5 * 100 / oplus_chg_debug_info.total_time_count;
	if (pct > 100) {
		pct = 100;
	}
	return pct;
...
static void oplus_chg_print_debug_info(struct oplus_chg_chip *chip)
{
	...
	if (oplus_chg_debug_info.notify_type || oplus_chg_debug_notify_flag_is_set(OPLUS_NOTIFY_CHARGER_INFO)) {
		...
		//add for common
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "type@@0x%x",
				oplus_chg_debug_info.notify_type);

		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$flag@@0x%llx",
				oplus_chg_debug_info.notify_flag);

		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$type_reason@@%s",
				oplus_chg_debug_info.type_reason);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$flag_reason@@%s",
				oplus_chg_debug_info.flag_reason);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$charging_state@@%s",
				charging_state_name[chip->prop_status]);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$adapter_type@@0x%x",
				(oplus_chg_debug_info.fast_chg_type << 8) | oplus_chg_debug_info.real_charger_type);
		if (oplus_chg_get_vooc_adapter_name_index(chip) >= 0) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"$$vooc_adapter_name@@%s",
					vooc_adapter_name[oplus_chg_get_vooc_adapter_name_index(chip)]);
		}

		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$norm_adapter_name@@%s",
				norm_adapter_name[oplus_chg_debug_info.real_charger_type]);

		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$rechg_counts@@%d",
				oplus_chg_debug_info.rechg_counts); /*add for rechg counts*/

		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$chg_total_time@@%d",
				oplus_chg_debug_info.chg_total_time);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$chg_start_temp@@%d",
				oplus_chg_debug_info.chg_start_temp);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$chg_start_soc@@%d",
				oplus_chg_debug_info.chg_start_ui_soc);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$chg_cur_temp@@%d",
				chip->temperature);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$cur_ui_soc@@%d",
				oplus_chg_debug_info.cur_ui_soc);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$cur_soc@@%d",
				oplus_chg_debug_info.cur_soc);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$fast_chg_percent@@%d",
		...
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$led_on_percent@@%d",
				oplus_chg_percent_cnt(OPLUS_NOTIFY_CHG_SLOW_LED_ON_LONG_TIME));

		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$sleep_time@@%lu",
				oplus_chg_debug_info.sleep_tm_sec);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$batt_fcc@@%d",
				chip->batt_fcc);
		if (oplus_chg_debug_info.report_soh) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$batt_soh@@%d",
					oplus_chg_debug_info.batt_soh);
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$batt_cc@@%d",
					oplus_chg_debug_info.batt_cc);
			oplus_chg_debug_info.report_soh = false;
		}
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$charge_status@@%d",
				chip->prop_status);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$boot_mode@@%d",
				chip->boot_mode);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$icharging@@%d",
				chip->icharging);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$vbat@@%d",
				chip->batt_volt);
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$cool_down@@%d",
				chip->cool_down);

		//add for soc jump
		if (oplus_chg_debug_notify_type_is_set(OPLUS_CHG_DEBUG_NOTIFY_TYPE_SOC_JUMP)) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$pre_soc@@%d",
					oplus_chg_debug_info.pre_soc);
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$pre_ui_soc@@%d",
					oplus_chg_debug_info.pre_ui_soc);
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$soc_load@@%d",
					chip->soc_load);
		}
		...
		if (oplus_chg_chg_is_normal_path(chip)) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$ibus@@%d",
					chip->ibus);
		} else {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$ibus@@%d",
					oplus_chg_debug_info.fastchg_input_current);
		}

		/*add for wireless chg*/
		if ((oplus_chg_debug_info.notify_type & (1 << OPLUS_CHG_DEBUG_NOTIFY_TYPE_WIRELESS))) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$tx_version@@0x%x",
					oplus_chg_debug_info.wireless_info.tx_version);
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$rx_version@@0x%x",
					oplus_chg_debug_info.wireless_info.rx_version);
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
		...
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
				...
				chip->boot_mode, oplus_chg_debug_info.chg_current_by_tbatt,
				oplus_chg_debug_info.chg_current_by_cooldown, chip->batt_exist, chip->batt_full,
				chip->chging_on, chip->in_rechging, chip->charging_state,
				oplus_chg_debug_info.total_time, chip->temperature, chip->batt_volt,
				chip->batt_volt_min, chip->icharging, chip->ibus, chip->soc, chip->ui_soc,
				chip->soc_load, chip->batt_rm, chip->batt_fcc, chip->vbatt_over, chip->chging_over_time,
				chip->vchg_status, chip->tbatt_status, chip->stop_voter, chip->notify_code,
				chip->sw_full, chip->hw_full_by_sw, chip->hw_full, chip->otg_switch, chip->mmi_chg,
		...
		if (oplus_switching_support_parallel_chg()) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"SUB_BATT[ %d / %d / %d / %d ],"
					"SWITCH_IC[%d / %d / %d / %d ],",
					chip->sub_batt_volt, chip->sub_batt_icharging, chip->sub_batt_soc,
					chip->sub_batt_temperature, oplus_switching_get_hw_enable(),
					oplus_switching_get_charge_enable(), oplus_switching_get_fastcharge_current(),
					oplus_switching_get_discharge_current());
		}

		if (oplus_chg_debug_info.fg_error_flag != 0 && oplus_chg_debug_info.fg_info) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"FG_CAN_NOT_UPDATE[%d] %s", oplus_chg_debug_info.fg_error_count,
					oplus_chg_debug_info.fg_info);
		}

		oplus_vooc_get_vooc_chip_handle(&vooc_chip);
		if (vooc_chip) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
					"VOOC[ %d / %d / %d / %d / %d / %d]", vooc_chip->fastchg_allow,
					vooc_chip->fastchg_started, vooc_chip->fastchg_dummy_started,
					vooc_chip->fastchg_to_normal, vooc_chip->fastchg_to_warm,
					vooc_chip->btb_temp_over);
		} /*add for voocPhy chg*/
		...
		if (oplus_chg_debug_info.wirelesspen_info.support) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
					...
					oplus_chg_debug_info.wirelesspen_info.ble_timeout_cnt,
					oplus_chg_debug_info.wirelesspen_info.verify_failed_cnt);
		...
		if (voocphy_chip) {
			...
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "VOOCPHY_REG[");
			for (i = 0; i < DUMP_REG_CNT; i++) {
				ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "%2X, ",
						voocphy_chip->reg_dump[i]);
			}
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "]");
			...
			if (oplus_chg_debug_info.sc85x7_error_reason[0] > 0) {
				...
				ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
						"%d, %d, %d, %d, %d]", voocphy_chip->master_cp_ichg,
						voocphy_chip->slave_cp_ichg, voocphy_chip->master_error_ibus,
						voocphy_chip->slave_error_ibus, voocphy_chip->error_current_expect);
			}
		}
		...
		if (pps_chip && pps_chip->pps_support_type) {
			ret += snprintf(
				&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret,
				"PPS_MSG[%d, %d, %d, %d, %d, %d] [%d, %d, %d, %d, %d, %d] [%d, %d, %d, %d, %d, %d]\
					ilimit[%d, %d, %d, %d, %d, %d] \
					data1[%d, %d, %d, %d, %d, %d, %d, %d]\
					data2[%d, %d, %d, %d, %d, %d][%d, %d, %d, %d, %d] [%d, %d, %d, %d, %d]\
					cp[%d, %d, %d, %d, %d, %d][%d, %d, %d, %d]\
					r[%d, %d, %d, %d, %d, %d, %d]",
				pps_chip->pps_support_type, pps_chip->pps_adapter_type, pps_chip->pps_power,
				pps_chip->pps_status, pps_chip->pps_stop_status, pps_chip->pps_chging,

				pps_chip->pps_fastchg_started, pps_chip->pps_dummy_started, pps_chip->batt_curve_index,
				pps_chip->pps_low_curr_full_temp_status, pps_chip->pps_temp_cur_range,
				pps_chip->pps_fastchg_batt_temp_status,

				pps_chip->target_charger_volt, pps_chip->target_charger_current,
				pps_chip->ask_charger_volt, pps_chip->ask_charger_current, pps_chip->pps_imax,
				pps_chip->pps_vmax,

				pps_chip->ilimit.current_batt_curve, pps_chip->ilimit.current_batt_temp,
				pps_chip->ilimit.current_cool_down, pps_chip->ilimit.cp_ibus_down,
				pps_chip->ilimit.cp_r_down, pps_chip->ilimit.cp_tdie_down,

				pps_chip->data.charger_output_volt, pps_chip->data.charger_output_current,
				pps_chip->data.ap_batt_volt, pps_chip->data.ap_batt_current, pps_chip->data.ap_batt_soc,
				pps_chip->data.ap_batt_temperature, pps_chip->data.current_adapter_max,
				pps_chip->data.vbat0,

				pps_chip->data.ap_input_volt, pps_chip->data.ap_input_current,
				pps_chip->data.cp_master_ibus, pps_chip->data.cp_master_vac,
				pps_chip->data.cp_master_vout, pps_chip->data.cp_master_tdie,

				pps_chip->data.cp_slave_vac, pps_chip->data.cp_slave_ibus,
				pps_chip->data.slave_input_volt, pps_chip->data.cp_slave_vout,
				pps_chip->data.cp_slave_tdie,

				pps_chip->data.cp_slave_b_vac, pps_chip->data.cp_slave_b_ibus,
				pps_chip->data.slave_b_input_volt, pps_chip->data.cp_slave_b_vout,
				pps_chip->data.cp_slave_b_tdie,

				pps_chip->cp.master_enable, pps_chip->cp.slave_enable, pps_chip->cp.slave_b_enable,
				pps_chip->cp.master_abnormal, pps_chip->cp.slave_abnormal, pps_chip->cp.iic_err,
				pps_chip->cp.iic_err_num, pps_chip->cp.master_enable_err_num,
				pps_chip->cp.slave_enable_err_num, pps_chip->cp.slave_b_enable_err_num,

				pps_chip->r_avg.r0, pps_chip->r_avg.r1, pps_chip->r_avg.r2, pps_chip->r_avg.r3,
				pps_chip->r_avg.r4, pps_chip->r_avg.r5, pps_chip->r_avg.r6);

			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "PPS_REG[18~1C/42][");
			for (i = 0; i < 6; i++) {
				ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "%2X, ",
						pps_chip->reg_dump[i]);
			}
		...
		if (chg_check_point_debug & OPEN_LOG_BIT) {
			int i;
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, ", CHG_CNT[");
			for (i = 0; i < OPLUS_NOTIFY_CHG_MAX_CNT; i++) {
				ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "%4d ",
						oplus_chg_debug_info.chg_cnt[i]);
			}
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "]");
		}
		...
		ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "$$Ver_Os@@%s", "2.0_12.0");

		if (oplus_chg_debug_info.notify_type & (1 << OPLUS_CHG_DEBUG_NOTIFY_TYPE_BCC_ERR)) {
			ret += snprintf(&oplus_chg_debug_msg[ret], OPLUS_CHG_DEBUG_MSG_LEN - ret, "%s",
...
static int oplus_chg_get_vooc_adapter_is_low_input_power(struct oplus_chg_chip *chip)
{
	...
	adapter_input_power = vooc_charger_type_list[vooc_adapter_type_index].vol *
			      vooc_charger_type_list[vooc_adapter_type_index].cur;

	if (adapter_input_power <
	    (oplus_chg_debug_info.vooc_max_input_volt * oplus_chg_debug_info.vooc_max_input_current))
		return 1;
...
static int oplus_chg_get_vooc_input_power(struct oplus_chg_chip *chip)
{
	...
	vol = oplus_chg_debug_info.vooc_max_input_volt < vooc_charger_type_list[i].vol ?
		      oplus_chg_debug_info.vooc_max_input_volt :
		      vooc_charger_type_list[i].vol;
	cur = oplus_chg_debug_info.vooc_max_input_current < vooc_charger_type_list[i].cur ?
		      oplus_chg_debug_info.vooc_max_input_current :
		      vooc_charger_type_list[i].cur;
	...
	if (oplus_chg_debug_info.vooc_charge_strategy) {
		...
		mcu_chg_current = oplus_chg_debug_info.vooc_charge_strategy
					  ->input_current[oplus_chg_debug_info.vooc_charge_input_current_index]
					  .cur;
...
static int oplus_chg_get_charge_power(struct oplus_chg_chip *chip)
{
	...
	if (chg_check_point_debug & OPEN_LOG_BIT) {
		chg_err("charge_pwoer: %d icharging = %d batt_volt = %d\n", charge_power, chip->icharging,
			chip->batt_volt); //debug tmp
	}
...
static int oplus_chg_set_notify_type(int index)
{
	...
	strcpy(oplus_chg_debug_info.type_reason, oplus_chg_debug_type_policy[index].reason);
...
static int oplus_chg_set_chg_flag(int index)
{
	...
	case OPLUS_CHG_NOTIFY_TOTAL:
		if (((oplus_chg_debug_info.chg_cnt[index] %
		      (policy_time * oplus_chg_debug_notify_policy[index].percent / 100)) == 0)) {
			oplus_chg_debug_info.notify_flag |= (1L << index);
		}
		rc = 0;
		break;
	...
	if (chg_check_point_debug & OPEN_LOG_BIT) {
		chg_err("cnt: %d, index: %d, flag: 0x%x\n", oplus_chg_debug_info.chg_cnt[index], index,
			oplus_chg_debug_info.notify_flag);
	}
	mutex_unlock(&oplus_chg_debug_info.nflag_lock);
...
static int oplus_chg_vooc_charge_strategy_init(struct oplus_chg_chip *chip)
{
	...
	if (oplus_chg_debug_info.vooc_charge_strategy != NULL) {
		for (i = oplus_chg_debug_info.vooc_charge_input_current_index; i < OPLUS_CHG_VOOC_INPUT_CURRENT_MAX_CNT;
		     i++) {
			if (chip->batt_volt <= oplus_chg_debug_info.vooc_charge_strategy->input_current[i].vol) {
				...
				if (oplus_chg_debug_info.vooc_charge_strategy->input_current[i].time > 0) {
					if (oplus_chg_debug_info.vooc_charge_cur_state_chg_time >=
					    oplus_chg_debug_info.vooc_charge_strategy->input_current[i].time) {
			...
			for (i = 0; vooc_charge_strategy_p[i].capacity_range.low != -1; i++) {
				if ((vooc_charge_strategy_p[i].capacity_range.low < start_soc) &&
					...
					chg_err("output_power_type: %d, capacity_range [%d, %d], temp_range [%d, %d]\n",
						output_power_type, vooc_charge_strategy_p[i].capacity_range.low,
...
static int oplus_chg_chg_is_normal_path(struct oplus_chg_chip *chip)
{
	...
	if (vooc_by_normal && (oplus_vooc_get_fast_chg_type() == CHARGER_SUBTYPE_FASTCHG_VOOC))
		return 1;
...
static int oplus_parallel_full_soc_error_check(struct oplus_chg_chip *chip)
{
	...
	power_supply_get_property(oplus_chg_debug_info.batt_psy, POWER_SUPPLY_PROP_STATUS, &pval);
...
static int oplus_parallel_limitic_error_check(struct oplus_chg_chip *chip)
{
	...
	if ((oplus_switching_get_charge_enable() == true) && (chip->sub_batt_icharging < 0 && chip->icharging < 0) &&
	    ((chip->sub_batt_icharging > -10 && chip->icharging < -500) ||
	     (chip->icharging > -10 && chip->sub_batt_icharging < -500))) {
		if (!oplus_chg_debug_notify_type_is_set(OPLUS_CHG_DEBUG_NOTIFY_TYPE_GAUGE_ERROR)) {
			oplus_chg_set_notify_type(OPLUS_CHG_DEBUG_NOTIFY_TYPE_GAUGE_ERROR);
...
static int oplus_chg_break_check(struct oplus_chg_chip *chip)
{
	...
	if (chip->detect_detach_unexpeactly == 1 || (break_flag == 1 && (chg_check_point_debug & OPEN_LOG_BIT))) {
...
{
	if (!g_debug_oplus_chip || !fg_erro_info || oplus_chg_debug_info.fg_error_count >= FG_ERROR_MAX_COUNT)
		return;
...
static int oplus_chg_input_power_limit_check(struct oplus_chg_chip *chip)
{
	...
	if (oplus_chg_chg_is_normal_path(chip)) {
		...
		pval.intval = 0;
		power_supply_get_property(oplus_chg_debug_info.usb_psy, POWER_SUPPLY_PROP_VOLTAGE_MAX, &pval);
...
{
	int soc_start = -1, soc_end = -1, speed_high = -1, speed_mid = -1, speed_low = -1, speed_lowest = -1;
	int current_high = -1, current_mid = -1, current_low = -1, current_lowest = -1;
	int time_ref = 0;
	...
	chg_err("speed_high:%d speed_mid:%d speed_low:%d speed_lowest:%d\n", speed_high, speed_mid, speed_low,
		speed_lowest); //debug temp

	if (soc_start < soc_high_speed) { //start < 51
		if (soc_end < soc_high_speed) { //start<51 end<51
			time_ref = speed_high * (soc_end - soc_start);
		} else if (soc_end < soc_mid_speed) { //start<51 end<76
			time_ref = speed_high * (soc_high_speed - soc_start) + speed_mid * (soc_end - soc_start);
		} else if (soc_end < soc_low_speed) { //start<51 end<91
			time_ref = speed_high * (soc_high_speed - soc_start) +
				   speed_mid * (soc_mid_speed - soc_high_speed) + speed_low * (soc_end - soc_start);
		} else if (soc_end < soc_loweset_speed) { //start<51 end<101
			time_ref = speed_high * (soc_high_speed - soc_start) +
				   speed_mid * (soc_mid_speed - soc_high_speed) +
				   speed_low * (soc_low_speed - soc_mid_speed) + speed_lowest * (soc_end - soc_start);
		}
	} else if (soc_start < soc_mid_speed) {
		if (soc_end < soc_mid_speed) {
			time_ref = speed_mid * (soc_end - soc_start);
		} else if (soc_end < soc_low_speed) {
			time_ref = speed_mid * (soc_mid_speed - soc_start) + speed_low * (soc_end - soc_start);
		} else if (soc_end < soc_loweset_speed) {
			time_ref = speed_mid * (soc_mid_speed - soc_start) +
				   speed_low * (soc_low_speed - soc_mid_speed) + speed_lowest * (soc_end - soc_start);
		}
	} else if (soc_start < soc_low_speed) {
		if (soc_end < soc_low_speed) {
			time_ref = speed_low * (soc_end - soc_start);
		} else if (soc_end < soc_loweset_speed) {
			time_ref = speed_low * (soc_low_speed - soc_start) + speed_lowest * (soc_end - soc_start);
		}
	} else if (soc_start < soc_loweset_speed) {
		time_ref = speed_lowest * (soc_end - soc_start);
	}
	...
	for (i = OPLUS_NOTIFY_CHG_SLOW_BATT_WARM_TEMP; i <= OPLUS_NOTIFY_CHG_SLOW_LED_ON_LONG_TIME; i++) {
		if (oplus_chg_debug_notify_policy[i].policy == OPLUS_CHG_NOTIFY_ONCE) {
			if (oplus_chg_debug_notify_flag_is_set(i)) {
				strcpy(oplus_chg_debug_info.flag_reason, oplus_chg_debug_notify_policy[i].reason);
				break;
			}
		}
		if (oplus_chg_debug_notify_policy[i].policy == OPLUS_CHG_NOTIFY_TOTAL) {
			if (oplus_chg_debug_info.chg_cnt[i] * 5 * 100 / oplus_chg_debug_info.total_time_count >
		...
		if (i == OPLUS_NOTIFY_CHG_SLOW_LED_ON_LONG_TIME) {
			strcpy(oplus_chg_debug_info.flag_reason, "Others");
			break;
		}
	}
...
static int oplus_chg_chg_slow_check(struct oplus_chg_chip *chip)
{
	...
	if ((oplus_chg_debug_info.pre_prop_status != chip->prop_status) &&
	    (chip->prop_status == POWER_SUPPLY_STATUS_CHARGING) && stop_chg_flag && chip->charger_exist) {
		stop_chg_flag = false;
	}
	if ((oplus_chg_debug_info.pre_prop_status != chip->prop_status) &&
	...
	if ((oplus_chg_debug_info.pre_led_state != chip->led_on) && (!chip->led_on)) {
	...
	if (chip->vooc_project && (oplus_vooc_get_fastchg_started() == true)) {
		...
		if (oplus_chg_get_vooc_adapter_is_low_input_power(chip)) {
		   ...
		   oplus_chg_debug_info.chg_cnt[OPLUS_NOTIFY_FAST_CHARGER_TIME] < 3 && chip->total_time > 30) {
...
static int oplus_chg_chg_batt_capacity_jump_check(struct oplus_chg_chip *chip)
{
	...
	if (oplus_chg_debug_info.cur_soc == OPLUS_CHG_BATT_INVALID_CAPACITY) {
		...
		if (abs(oplus_chg_debug_info.cur_ui_soc - chip->soc_load) >
		    OPLUS_CHG_BATT_UI_SOC_CAPACITY_LOAD_JUMP_NUM) {
		...
		if ((abs(oplus_chg_debug_info.cur_soc - oplus_chg_debug_info.pre_soc) >
		     OPLUS_CHG_BATT_SOC_CAPACITY_JUMP_NUM) &&
			...
			if ((abs(oplus_chg_debug_info.cur_ui_soc - oplus_chg_debug_info.pre_ui_soc) >
			     OPLUS_CHG_BATT_UI_SOC_CAPACITY_JUMP_NUM) &&
				...
				if (oplus_chg_debug_notify_flag_is_set(OPLUS_NOTIFY_BATT_UI_SOC_CAPCITY_JUMP)) {
					...
					strcpy(oplus_chg_debug_info.flag_reason,
					       oplus_chg_debug_notify_policy[OPLUS_NOTIFY_BATT_UI_SOC_CAPCITY_JUMP]
						       .reason);
				}
			} else {
				...
				if ((abs(oplus_chg_debug_info.cur_ui_soc - oplus_chg_debug_info.cur_soc) >
				     OPLUS_CHG_BATT_UI_TO_SOC_CAPACITY_JUMP_NUM) &&
					...
					if (oplus_chg_debug_notify_flag_is_set(
						    OPLUS_NOTIFY_BATT_UI_TO_SOC_CAPCITY_JUMP)) {
						oplus_chg_set_notify_type(OPLUS_CHG_DEBUG_NOTIFY_TYPE_SOC_JUMP);
						oplus_chg_set_soc_notified_flag(
							OPLUS_NOTIFY_BATT_UI_TO_SOC_CAPCITY_JUMP);
						strcpy(oplus_chg_debug_info.flag_reason,
						       oplus_chg_debug_notify_policy
							       [OPLUS_NOTIFY_BATT_UI_TO_SOC_CAPCITY_JUMP]
								       .reason);
					...
					if (oplus_chg_debug_info.cur_ui_soc == oplus_chg_debug_info.cur_soc) {
						ui_to_soc_jump_flag = false;
						oplus_chg_unset_soc_notified_flag(
							OPLUS_NOTIFY_BATT_UI_TO_SOC_CAPCITY_JUMP);
					}
					if ((status == POWER_SUPPLY_STATUS_FULL) &&
					    (oplus_chg_debug_info.cur_soc != 100) &&
...
void oplus_chg_wireless_error(int error, struct wireless_chg_debug_info *wireless_param)
{
	...
	if (!oplus_chg_debug_notify_type_is_set(OPLUS_CHG_DEBUG_NOTIFY_TYPE_WIRELESS)) {
		...
		if (!oplus_chg_debug_notify_flag_is_set(error)) {
			...
			strcpy(oplus_chg_debug_info.flag_reason, oplus_chg_debug_notify_policy[error].reason);
			oplus_chg_print_debug_info(g_debug_oplus_chip);
			send_info_flag = SEND_INFO_FLAG_IRQ;
		}
	}
...
void oplus_chg_sc8571_error(int report_flag, int *buf, int ret)
{
	...
	if (report_flag & (1 << PPS_REPORT_ERROR_TFG_OVER)) {
		strcpy(reason, "TFG_OVER ");
	}
	...
	if (report_flag & (1 << PPS_REPORT_ERROR_STARTUP_FAIL)) {
		strcpy(reason, "STARTUP_FAIL ");
	}
		...
		if (!strncmp(buf, "1", 1)) {
			if (!oplus_chg_debug_notify_flag_is_set(OPLUS_NOTIFY_BCC_CURR_ADJUST_ERR)) {
				...
				if (strlen(buf + BCC_LENGTH_DELETE) < BCC_LINE_LENGTH_MAX)
					strncpy(oplus_chg_debug_info.bcc_buf, buf + BCC_LENGTH_DELETE,
						strlen(buf + BCC_LENGTH_DELETE));
				else
					strncpy(oplus_chg_debug_info.bcc_buf, buf + BCC_LENGTH_DELETE,
						BCC_LINE_LENGTH_MAX);
			}
...
static int oplus_chg_debug_info_parse_dt(struct oplus_chg_chip *chip)
{
	...
	int size;
	u32 val[2];
	char *vooc_adpater_name[] = { "vooc_charge_strategy_20w", "vooc_charge_strategy_30w",
				      "vooc_charge_strategy_33w", "vooc_charge_strategy_50w",
	...
	ret = of_property_read_u32(vooc_node, "qcom,vooc-max-input-volt-support",
				   &oplus_chg_debug_info.vooc_max_input_volt);
	if (ret) {
		oplus_chg_debug_info.vooc_max_input_volt = 5000;
	}

	ret = of_property_read_u32(vooc_node, "qcom,vooc-max-input-current-support",
				   &oplus_chg_debug_info.vooc_max_input_current);
	if (ret) {
...
static ssize_t charge_monitor_test_write(struct file *filp, const char __user *buf, size_t len, loff_t *data)
{
	char tmp_buf[32] = { 0 };
	int str_len;
	...
	if (!strncmp(tmp_buf, "soc:", strlen("soc:"))) {
		...
		if (gauge_seal_flag == OPLUS_GAUGE_SEAL_FAIL || gauge_seal_flag == OPLUS_GAUGE_UNSEAL_FAIL) {
...
static ssize_t charge_monitor_test_read(struct file *filp, char __user *buff, size_t count, loff_t *off)
{
	int len = 0;
	char buf[512] = { 0 };
...
static int charge_monitor_test_init(void)
{
	...
	proc_dentry = proc_create("charge_monitor_test", 0664, NULL, &charge_monitor_test_fops);
	if (!proc_dentry) {
