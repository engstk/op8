...
static int aw8697_i2c_reads(struct aw8697 *aw8697, unsigned char reg_addr,
			    unsigned char *buf, unsigned int len)
{
	int ret = -1;
				    ...
				    struct aw8697_container *aw8697_cont)
{
	...
	aw8697_i2c_write(aw8697, AW8697_REG_FIFO_AEL,
			 (unsigned char)((aw8697->ram.base_addr >> 1) &
					 0x00FF));
	...
	if (aw8697->device_id == 832) {
		...
		if (aw8697->vibration_style ==
			...
			return request_firmware_nowait(
				...
				aw8697_ram_name_150[index], aw8697->dev,
...
aw8697_old_work_file_load_accord_f0(struct aw8697 *aw8697)
{
	const struct firmware *rtp_file;
...
const struct firmware *aw8697_rtp_load_file_accord_f0(struct aw8697 *aw8697)
{
	...
	if ((aw8697->rtp_file_num >= RINGTONES_START_INDEX &&
	     aw8697->rtp_file_num <= RINGTONES_END_INDEX) ||
	    (aw8697->rtp_file_num >= NEW_RING_START &&
	     aw8697->rtp_file_num <= NEW_RING_END) ||
	    (aw8697->rtp_file_num >= OS12_NEW_RING_START &&
	     aw8697->rtp_file_num <= OS12_NEW_RING_END) ||
		...
		if (aw8697->rtp_file_num == AW8697_RTP_LONG_SOUND_INDEX) {
			ret = request_firmware(
				...
				aw8697->dev);
		} else if (aw8697->rtp_file_num ==
			   AW8697_WAVEFORM_INDEX_OLD_STEADY) {
			ret = request_firmware(
				&rtp_file,
...
static unsigned char one_sine_data_1815[] = {
	...
	0x14, 0x14, 0x14, 0x14, 0x13, 0x13, 0x13, 0x13, 0x12, 0x12, 0x12, 0x11,
	0x11, 0x10, 0x10, 0x0f, 0x0e, 0x0e, 0x0d, 0x0d, 0x0c, 0x0b, 0x0a, 0x0a,
	0x09, 0x08, 0x07, 0x06, 0x05, 0x05, 0x04, 0x03, 0x02, 0x01, 0x00, 0x00,
	0xff, 0xfe, 0xfd, 0xfd, 0xfc, 0xfb, 0xfa, 0xf9, 0xf8, 0xf7, 0xf7, 0xf6,
	0xf5, 0xf4, 0xf4, 0xf3, 0xf2, 0xf2, 0xf1, 0xf0, 0xf0, 0xef, 0xef, 0xef,
	0xee, 0xee, 0xed, 0xed, 0xed, 0xed, 0xec, 0xec, 0xec, 0xec, 0xec, 0xec,
	0xec, 0xec, 0xec, 0xed, 0xed, 0xed, 0xed, 0xee, 0xee, 0xef, 0xef, 0xf0,
	0xf0, 0xf1, 0xf1, 0xf2, 0xf2, 0xf3, 0xf4, 0xf4, 0xf5, 0xf6, 0xf7, 0xf8,
...
static unsigned char one_sine_data_0832[] = {
	...
	0x1c, 0x1b, 0x19, 0x18, 0x16, 0x15, 0x13, 0x11, 0x0f, 0x0d, 0x0b, 0x09,
	0x06, 0x04, 0x02, 0x00, 0xff, 0xfd, 0xfa, 0xf8, 0xf6, 0xf4, 0xf2, 0xf0,
	0xee, 0xec, 0xea, 0xe9, 0xe7, 0xe6, 0xe4, 0xe3, 0xe2, 0xe1, 0xe0, 0xdf,
	0xde, 0xde, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xdd, 0xde, 0xdf, 0xdf,
	0xe0, 0xe1, 0xe2, 0xe4, 0xe5, 0xe6, 0xe8, 0xea, 0xeb, 0xed, 0xef, 0xf1,
...
static unsigned char one_sine_data_0619[] = {
	...
	0x1b, 0x1b, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a, 0x19, 0x19, 0x18, 0x18, 0x17,
	0x17, 0x16, 0x15, 0x15, 0x14, 0x13, 0x12, 0x11, 0x10, 0x0f, 0x0e, 0x0d,
	0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x05, 0x04, 0x03, 0x02, 0x01, 0x00,
	0xff, 0xfe, 0xfd, 0xfc, 0xfa, 0xf9, 0xf8, 0xf7, 0xf6, 0xf5, 0xf4, 0xf3,
	0xf2, 0xf1, 0xf0, 0xef, 0xee, 0xed, 0xec, 0xeb, 0xeb, 0xea, 0xe9, 0xe9,
	0xe8, 0xe8, 0xe7, 0xe7, 0xe6, 0xe6, 0xe6, 0xe6, 0xe5, 0xe5, 0xe5, 0xe5,
	0xe5, 0xe6, 0xe6, 0xe6, 0xe6, 0xe7, 0xe7, 0xe7, 0xe8, 0xe8, 0xe9, 0xea,
	0xea, 0xeb, 0xec, 0xed, 0xed, 0xee, 0xef, 0xf0, 0xf1, 0xf2, 0xf3, 0xf4,
	0xf5, 0xf6, 0xf8, 0xf9, 0xfa, 0xfb, 0xfc, 0xfd, 0xff,
};
...
static unsigned char one_sine_data_1040[] = {
	...
	0x1a, 0x1b, 0x1b, 0x1b, 0x1a, 0x1a, 0x1a, 0x1a, 0x1a, 0x19, 0x19, 0x19,
	0x18, 0x18, 0x17, 0x17, 0x16, 0x15, 0x15, 0x14, 0x13, 0x12, 0x12, 0x11,
	0x10, 0x0f, 0x0e, 0x0d, 0x0c, 0x0b, 0x0a, 0x09, 0x08, 0x07, 0x06, 0x05,
	0x04, 0x02, 0x01, 0x00, 0x00, 0xff, 0xfe, 0xfd, 0xfc, 0xfb, 0xf9, 0xf8,
	0xf7, 0xf6, 0xf5, 0xf4, 0xf3, 0xf2, 0xf1, 0xf0, 0xf0, 0xef, 0xee, 0xed,
	0xec, 0xec, 0xeb, 0xea, 0xea, 0xe9, 0xe9, 0xe8, 0xe8, 0xe7, 0xe7, 0xe6,
	0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe5, 0xe5, 0xe5, 0xe6, 0xe6, 0xe6, 0xe6,
	0xe6, 0xe7, 0xe7, 0xe7, 0xe8, 0xe8, 0xe9, 0xe9, 0xea, 0xeb, 0xeb, 0xec,
	0xed, 0xee, 0xef, 0xef, 0xf0, 0xf1, 0xf2, 0xf3, 0xf4, 0xf5, 0xf6, 0xf7,
...
{
	aw8697->sin_num =
		((aw8697->duration - 500) * 100 / one_sine_data_time) + 1;
	aw8697->sin_data_lenght =
		(size_t)(aw8697->sin_num * one_sine_data_length);
}

static void aw8697_update_rtp_data(struct aw8697 *aw8697,
				   const struct firmware *rtp_file)
{
	int i = 0;
	...
	for (i = 1; i <= aw8697->sin_num; i++) {
		memcpy(temp_rtp_data + data_location, one_sine_data,
		       one_sine_data_length);
		data_location += one_sine_data_length;
	}

	memcpy(temp_rtp_data + data_location,
	       rtp_file->data + rtp_500ms_first_sine_place,
	       rtp_file->size - rtp_500ms_first_sine_place);
...
static void aw8697_rtp_work_routine(struct work_struct *work)
{
	...
	if (aw8697->sin_add_flag == 1) {
		...
		ret = aw8697_container_init(
			rtp_file->size + aw8697->sin_data_lenght + sizeof(int));
		if (ret < 0) {
			release_firmware(rtp_file);
			mutex_unlock(&aw8697->rtp_lock);
			pr_err("%s: error allocating memory\n", __func__);
...
{
	struct aw8697 *aw8697 =
		container_of(work, struct aw8697, rtp_single_cycle_work);
	const struct firmware *rtp_file;
	int ret = -1;
	unsigned int buf_len = 0;
	unsigned char reg_val = 0;
...
{
	struct aw8697 *aw8697 =
		container_of(work, struct aw8697, rtp_regroup_work);
	const struct firmware *rtp_file;
	unsigned int buf_len = 0;
	unsigned char reg_val = 0;
	unsigned int cyc_cont = 150;
...
static int aw8697_rtp_regroup_work(struct aw8697 *aw8697)
{
	...
	if (aw8697->rtp_serial[0] > 0) {
		...
		aw8697_interrupt_clear(aw8697);
		if (aw8697->rtp_serial[0] <=
		    (sizeof(aw8697_rtp_name) / AW8697_RTP_NAME_MAX)) {
			if (aw8697->rtp_loop ==
			    0xFF) { //if aw8697->rtp_loop = 0xff then  single cycle ;
				aw8697->rtp_cycle_flag = 1;
				schedule_work(&aw8697->rtp_single_cycle_work);
			} else if ((aw8697->rtp_loop > 0) &&
				   (aw8697->rtp_loop < 0xff)) {
				aw8697->rtp_cycle_flag = 1;
...
#endif
static int
aw8697_haptic_audio_ctr_list_insert(struct haptic_audio *haptic_audio,
...
static void aw8697_haptic_audio_work_routine(struct work_struct *work)
{
			...
			list_for_each_entry_safe_reverse(
				...
				if ((p_ctr->play == 0) &&
				    (AW8697_HAPTIC_CMD_ENABLE ==
				     (AW8697_HAPTIC_CMD_HAPTIC & p_ctr->cmd))) {
					list_del(&p_ctr->list);
					kfree(p_ctr);
					ctr_list_del_cnt++;
				}
	...
	if ((aw8697->haptic_audio.ctr.cmd & AW8697_HAPTIC_CMD_HAPTIC) ==
	    AW8697_HAPTIC_CMD_ENABLE) {
		if (aw8697->haptic_audio.ctr.play ==
	...
	if (aw8697_haptic_get_f0(aw8697)) {
		...
		if (aw8697->device_id == 832 || aw8697->device_id == 833) {
			if (aw8697->f0 * 100 <
				...
				f0_limit = AW8697_0832_HAPTIC_F0_PRE *
					   (100 -
			...
			if (aw8697->f0 * 100 <
			    AW8697_081538_HAPTIC_F0_PRE *
				    (100 -
				     AW8697_081538_HAPTIC_F0_CALI_PERCEN)) {
				f0_limit =
					AW8697_081538_HAPTIC_F0_PRE *
					(100 -
					 AW8697_081538_HAPTIC_F0_CALI_PERCEN) /
			...
			if (aw8697->f0 * 100 <
			    AW8697_0815_HAPTIC_F0_PRE *
				    (100 - AW8697_0815_HAPTIC_F0_CALI_PERCEN)) {
				f0_limit = AW8697_0815_HAPTIC_F0_PRE *
					   (100 -
					    AW8697_0815_HAPTIC_F0_CALI_PERCEN) /
					   100;
			}
			if (aw8697->f0 * 100 >
			    AW8697_0815_HAPTIC_F0_PRE *
...
#else
		if (aw8697->f0 * 100 <
		    AW8697_HAPTIC_F0_PRE *
			    (100 - AW8697_HAPTIC_F0_CALI_PERCEN)) {
			f0_limit = AW8697_HAPTIC_F0_PRE *
				   (100 - AW8697_HAPTIC_F0_CALI_PERCEN) / 100;
		}
		if (aw8697->f0 * 100 >
		    AW8697_HAPTIC_F0_PRE *
			    (100 + AW8697_HAPTIC_F0_CALI_PERCEN)) {
...
static ssize_t proc_vibration_style_write(struct file *filp,
...
static int init_vibrator_proc(struct aw8697 *aw8697)
{
	...
	if (prEntry_da == NULL) {
		ret = -ENOMEM;
		dev_err(aw8697->dev,
			"%s: Couldn't create vibrator proc entry\n", __func__);
	}
...
aw8697_haptic_brightness_get(struct led_classdev *cdev)
{
	struct aw8697 *aw8697 = container_of(cdev, struct aw8697, cdev);
				     ...
				     const char *buf, size_t count)
{
	...
	if (aw8697->state) {
#ifdef CONFIG_OPLUS_HAPTIC_OOS
		if ((aw8697->boot_mode == MSM_BOOT_MODE__FACTORY ||
		     aw8697->boot_mode == MSM_BOOT_MODE__RF ||
		     aw8697->boot_mode == MSM_BOOT_MODE__WLAN)) {
			aw8697->gain = 0x60;
			mutex_lock(&aw8697->lock);
			aw8697_haptic_set_gain(aw8697, aw8697->gain);
		...
		aw8697_haptic_set_repeat_wav_seq(
			aw8697, AW8697_WAVEFORM_INDEX_SINE_CYCLE);
...
static struct aw8697_vmax_map vmax_map[] = {
	...
	{ 1700, 0x02, 0x75 }, { 1800, 0x04, 0x75 }, { 1900, 0x06, 0x75 },
	{ 2000, 0x08, 0x75 }, { 2100, 0x10, 0x75 }, { 2200, 0x12, 0x75 },
...
static struct aw8697_vmax_map vmax_map[] = {
	...
	{ 1700, 0x04, 0x80 }, { 1800, 0x07, 0x80 }, { 1900, 0x0A, 0x80 },
	{ 2000, 0x0D, 0x80 }, { 2100, 0x10, 0x80 }, { 2200, 0x12, 0x80 },
	{ 2300, 0x15, 0x80 }, { 2400, 0x18, 0x80 },
};
#endif
				...
				struct device_attribute *attr, char *buf)
{
	...
	count += snprintf(buf + count, PAGE_SIZE - count, "loop: 0x%02x\n",
			  aw8697->rtp_loop);
	return count;
}
				 ...
				 size_t count)
{
	...
	if (2 == sscanf(buf, "%x %x", &databuf[0], &databuf[1])) {
		...
		if (rc < 0)
			return rc;
		aw8697->rtp_loop = val;
		printk("%s  aw8697->rtp_loop = 0x%x", __func__,
		       aw8697->rtp_loop);
	}
				    ...
				    const char *buf, size_t count)
{
	...
	unsigned int databuf[AW8697_RTP_NUM] = {
		0, 0, 0, 0, 0, 0
	}; /*custom modify it,if you want*/
	unsigned int val = 0;
	int rc = 0;

	if (AW8697_RTP_NUM == sscanf(buf, "%x %x %x %x %x %x", &databuf[0],
				     &databuf[1], &databuf[2], &databuf[3],
				     &databuf[4], &databuf[5])) {
...
static ssize_t aw8697_short_check_show(struct device *dev,
				       struct device_attribute *attr, char *buf)
{
	struct led_classdev *cdev = dev_get_drvdata(dev);
	struct aw8697 *aw8697 = container_of(cdev, struct aw8697, cdev);
...
static ssize_t aw8697_short_check_store(struct device *dev,
					struct device_attribute *attr,
					const char *buf, size_t count)
{
	return count;
...
#else
	if (aw8697->f0 * 100 <
	    AW8697_HAPTIC_F0_PRE * (100 - AW8697_HAPTIC_F0_CALI_PERCEN)) {
		f0_limit = AW8697_HAPTIC_F0_PRE *
			   (100 - AW8697_HAPTIC_F0_CALI_PERCEN) / 100;
	}
	if (aw8697->f0 * 100 >
...
static ssize_t aw8697_f0_data_store(struct device *dev,
				    struct device_attribute *attr,
				    const char *buf, size_t count)
{
#ifdef TIMED_OUTPUT
...
static ssize_t aw8697_rtp_going_show(struct device *dev,
				     struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
...
static void motor_old_test_work(struct work_struct *work)
{
	...
	if (aw8697->motor_old_test_mode == MOTOR_OLD_TEST_TRANSIENT) {
		...
		aw8697_haptic_set_wav_seq(aw8697, 0,
...
static ssize_t aw8697_motor_old_test_show(struct device *dev,
					  struct device_attribute *attr,
					  char *buf)
{
	return 0;
...
static ssize_t aw8697_motor_old_test_store(struct device *dev,
					   struct device_attribute *attr,
					   const char *buf, size_t count)
{
#ifdef TIMED_OUTPUT
...
static ssize_t aw8697_waveform_index_show(struct device *dev,
					  struct device_attribute *attr,
					  char *buf)
{
	return 0;
...
static ssize_t aw8697_waveform_index_store(struct device *dev,
					   struct device_attribute *attr,
					   const char *buf, size_t count)
{
#ifdef TIMED_OUTPUT
	...
	if (1 == sscanf(buf, "%d", &databuf[0])) {
		...
		aw8697_haptic_set_wav_loop(aw8697, 0, 0);
#ifdef CONFIG_OPLUS_HAPTIC_OOS
		if (databuf[0] == 0x10 || databuf[0] == 0x11 ||
		    databuf[0] == 0x12) {
			if (aw8697->gain > 0x75) {
				aw8697->gain = 0x75;
			}
...
static ssize_t aw8697_osc_data_show(struct device *dev,
				    struct device_attribute *attr, char *buf)
{
#ifdef TIMED_OUTPUT
	struct timed_output_dev *to_dev = dev_get_drvdata(dev);
...
static ssize_t aw8697_osc_data_store(struct device *dev,
				     struct device_attribute *attr,
				     const char *buf, size_t count)
{
#ifdef TIMED_OUTPUT
...
static ssize_t aw8697_haptic_ram_test_show(struct device *dev,
					   struct device_attribute *attr,
					   char *buf)
{
#ifdef TIMED_OUTPUT
...
static ssize_t aw8697_haptic_ram_test_store(struct device *dev,
					    struct device_attribute *attr,
					    const char *buf, size_t count)
{
#ifdef TIMED_OUTPUT
	...
	if (val == 1) {
		...
		for (j = 0; j < retries; j++) {
			...
			aw8697_i2c_reads(aw8697, AW8697_REG_RAMDATA, pbuf,
					 aw8697_ramtest->len);
...
static DEVICE_ATTR(gain, S_IWUSR | S_IRUGO, aw8697_gain_show,
		   aw8697_gain_store);
static DEVICE_ATTR(level, S_IWUSR | S_IRUGO, aw8697_level_show,
		   aw8697_level_store);
...
static DEVICE_ATTR(cali, S_IWUSR | S_IRUGO, aw8697_cali_show,
		   aw8697_cali_store);
#ifdef CONFIG_OPLUS_HAPTIC_OOS
static DEVICE_ATTR(short_circuit_check, S_IWUSR | S_IRUGO,
		   aw8697_short_check_show, aw8697_short_check_store);
#endif
...
static DEVICE_ATTR(rtp_num, S_IWUSR | S_IRUGO, aw8697_rtp_num_show,
		   aw8697_rtp_num_store);
...
static DEVICE_ATTR(waveform_index, S_IWUSR | S_IRUGO,
		   aw8697_waveform_index_show, aw8697_waveform_index_store);
static DEVICE_ATTR(osc_data, S_IWUSR | S_IRUGO, aw8697_osc_data_show,
		   aw8697_osc_data_store);
static DEVICE_ATTR(ram_test, S_IWUSR | S_IRUGO, aw8697_haptic_ram_test_show,
		   aw8697_haptic_ram_test_store);
static DEVICE_ATTR(f0_data, S_IWUSR | S_IRUGO, aw8697_f0_data_show,
		   aw8697_f0_data_store);
...
static DEVICE_ATTR(gun_type, S_IWUSR | S_IRUGO, aw8697_gun_type_show,
		   aw8697_gun_type_store); //hch 20190917
static DEVICE_ATTR(bullet_nr, S_IWUSR | S_IRUGO, aw8697_bullet_nr_show,
		   aw8697_bullet_nr_store); //hch 20190917
static DEVICE_ATTR(gun_mode, S_IWUSR | S_IRUGO, aw8697_gun_mode_show,
		   aw8697_gun_mode_store); //hch 20190917
...
static int aw8697_vibrator_init(struct aw8697 *aw8697)
{
	...
	ret = sysfs_create_group(&aw8697->to_dev.dev->kobj,
	...
	ret = sysfs_create_group(&aw8697->cdev.dev->kobj,
				 &aw8697_vibrator_attribute_group);
	if (ret < 0) {
		dev_err(aw8697->dev, "%s error creating sysfs attr files\n",
			__func__);
			...
			while ((!aw8697_haptic_rtp_get_fifo_afi(aw8697)) &&
				...
				if (aw8697->rtp_cnt <= aw8697_rtp->len)
					aw8697_i2c_writes(
						...
						buf_len);
				aw8697->rtp_cnt += buf_len;
				aw8697_i2c_read(aw8697, AW8697_REG_GLB_STATE,
						&glb_state_val);
				if (aw8697->rtp_cnt >= aw8697_rtp->len ||
...
static struct attribute *aw8697_attributes[] = { &dev_attr_reg.attr,
						 &dev_attr_ram.attr, NULL };
			    ...
			    const struct i2c_device_id *id)
{
...
#ifdef AAC_RICHTAP
	aw8697->rtp_ptr = kmalloc(RICHTAP_MMAP_BUF_SIZE * RICHTAP_MMAP_BUF_SUM,
				  GFP_KERNEL);
	...
	aw8697->start_buf = (struct mmap_buf_format *)__get_free_pages(
		GFP_KERNEL, RICHTAP_MMAP_PAGE_ORDER);
...
static const struct i2c_device_id aw8697_i2c_id[] = { { AW8697_I2C_NAME, 0 },
						      {} };
