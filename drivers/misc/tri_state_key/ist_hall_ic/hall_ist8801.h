 ...
 *[4]	 INT_TYP  = 0 : generate interrupt when
 *raw data is beside range of threshold
 *[4]	 INT_TYP  = 1 : generate interrupt when
 * raw data is within range of threshold
...
#define GAIN_2_TIME (0x1 << 5)
#define GAIN_4_TIME (0x2 << 5)
#define GAIN_8_TIME (0x3 << 5)
