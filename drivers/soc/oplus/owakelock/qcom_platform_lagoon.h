...
#ifndef __QCOM_PLATFORM_LAGOON_H__
#define __QCOM_PLATFORM_LAGOON_H__

#include "oplus_wakelock_profiler.h"

static struct wakeup_count_desc_t wc_powerkey_lagoon = {
...
static struct wakeup_count_desc_t wc_rtc_alarm_lagoon = {
...
static struct wakeup_count_desc_t wc_modem_lagoon = {
	.module_name = "modem",
...
static struct wakeup_count_desc_t wc_wlan_lagoon = {
	.module_name = "wlan",
...
static struct wakeup_count_desc_t wc_adsp_lagoon = {
	.module_name = "adsp",
...
static struct wakeup_count_desc_t wc_cdsp_lagoon = {
	.module_name = "cdsp",
...
static struct wakeup_count_desc_t wc_slpi_lagoon = {
	.module_name = "slpi",
...
static struct wakeup_count_desc_t wc_glink_lagoon = {
...
static struct wakeup_count_desc_t wc_abort_lagoon = {
...
static struct wakeup_count_desc_t wc_sum_lagoon = {
 ...
 */
static struct wakeup_count_desc_t * const all_modules_lagoon[] = {
	&wc_powerkey_lagoon,
	&wc_rtc_alarm_lagoon,
	/*&wc_alarm_lagoon,*/
	&wc_modem_lagoon,
 ...
 */
static const char* const modem_report_exchange_lagoon[][MODEM_REPORT_NUMBER] = {
	{IRQ_NAME_MODEM_IPA, IRQ_NAME_MODEM_QMI},
	{NULL, NULL},
};

#endif /*__QCOM_PLATFORM_LAGOON_H__*/
