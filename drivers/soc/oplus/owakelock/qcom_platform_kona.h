...
#ifndef __QCOM_PLATFORM_KONA_H__
#define __QCOM_PLATFORM_KONA_H__

#include "oplus_wakelock_profiler.h"

static struct wakeup_count_desc_t wc_powerkey_kona = {
...
static struct wakeup_count_desc_t wc_rtc_alarm_kona = {
...
static struct wakeup_count_desc_t wc_modem_kona = {
	.module_name = "modem",
...
static struct wakeup_count_desc_t wc_wlan_kona = {
	.module_name = "wlan",
...
static struct wakeup_count_desc_t wc_adsp_kona = {
	.module_name = "adsp",
...
static struct wakeup_count_desc_t wc_cdsp_kona = {
	.module_name = "cdsp",
...
static struct wakeup_count_desc_t wc_slpi_kona = {
	.module_name = "slpi",
...
static struct wakeup_count_desc_t wc_glink_kona = {
...
static struct wakeup_count_desc_t wc_abort_kona = {
...
static struct wakeup_count_desc_t wc_sum_kona = {
 ...
 */
static struct wakeup_count_desc_t * const all_modules_kona[] = {
	&wc_powerkey_kona,
	&wc_rtc_alarm_kona,
	/*&wc_alarm_kona,*/
	&wc_modem_kona,
 ...
 */
static const char* const modem_report_exchange_kona[][MODEM_REPORT_NUMBER] = {
	{IRQ_NAME_MODEM_IPA, IRQ_NAME_MODEM_QMI},
	{NULL, NULL},
};

#endif /*__QCOM_PLATFORM_KONA_H__*/