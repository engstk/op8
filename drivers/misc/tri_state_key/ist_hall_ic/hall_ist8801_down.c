 ...
 */
static bool ist8801_down_update_threshold(int position, short lowthd,
					  short highthd)
{
...
static int ist8801_parse_dts(struct device *dev, struct ist8801_data_t *p_data)
{
	...
	p_data->irq_state =
		pinctrl_lookup_state(p_data->pctrl, "ist8801_hall_down_active");
			     ...
			     const struct i2c_device_id *id)
{
	...
	oplus_register_hall("hall_down", &ist8801_down_ops, hall_dev);
	TRI_KEY_LOG("success.\n");
	return 0;
fail:
	TRI_KEY_LOG("fail.\n");
 ...
 *};
 */
struct i2c_driver ist8801_i2c_down_driver = {
	.driver = {
...
late_initcall(ist8801_down_init);
