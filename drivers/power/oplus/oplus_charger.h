...
#if IS_ENABLED(CONFIG_OPLUS_CHG_TEST_KIT)
enum cc_mode_type { MODE_DEFAULT = 0, MODE_SINK, MODE_SRC, MODE_DRP };
enum situations_type { SITUATION_DEFAULT = 0, SITUATION_IDLE, SITUATION_OTG, SITUATION_CHARGING };
...
static struct usbtemp_curr temp_curr_table[USBTEMP_CURR_TABLE_MAX] = { { 5000, 12 }, { 6000, 18 }, { 10000, 20 } };
...
typedef enum { AGING_FFC_NOT_SUPPORT, AGING_FFC_V1, AGING_FFC_VERSION_MAX } AGING_FFC_VERSION;

typedef enum { SUBBOARD_NTC_ABNORMAL, SUBBOARD_NTC_NORMAL } SUBBOARD_NTC_ABNORMAL_STATUS;
...
int __attribute__((weak)) ppm_sys_boost_min_cpu_freq_set(int freq_min, int freq_mid, int freq_max,
 ...
 **********************************************/
extern int oplus_usb_get_property(struct power_supply *psy, enum power_supply_property psp,
				  union power_supply_propval *val);
extern int oplus_ac_get_property(struct power_supply *psy, enum power_supply_property psp,
				 union power_supply_propval *val);
extern int oplus_battery_property_is_writeable(struct power_supply *psy, enum power_supply_property psp);
extern int oplus_battery_set_property(struct power_supply *psy, enum power_supply_property psp,
				      const union power_supply_propval *val);
extern int oplus_battery_get_property(struct power_supply *psy, enum power_supply_property psp,
				      union power_supply_propval *val);
