...
static int da9313_work_mode_set(int work_mode)
{
	...
	if (divider_ic->fixed_mode_set_by_dev_file == true && work_mode == DA9313_WORK_MODE_AUTO) {
	...
	case HWID_DA9313:
		if (work_mode != 0) {
			rc = da9313_config_interface(REG04_DA9313_ADDRESS, REG04_DA9313_PVC_MODE_AUTO,
						     REG04_DA9313_PVC_MODE_MASK);
		} else {
			rc = da9313_config_interface(REG04_DA9313_ADDRESS, REG04_DA9313_PVC_MODE_FIXED,
						     REG04_DA9313_PVC_MODE_MASK);
		}
		break;
	case HWID_MAX77932:
		if (work_mode != 0) {
			rc = da9313_config_interface(REG04_DA9313_ADDRESS, REG04_MAX77932_PVC_MODE_AUTO,
						     REG04_MAX77932_PVC_MODE_MASK);
		} else {
			rc = da9313_config_interface(REG04_DA9313_ADDRESS, REG04_MAX77932_PVC_MODE_FIXED,
						     REG04_MAX77932_PVC_MODE_MASK);
		}
		break;
	case HWID_MAX77938:
		if (work_mode != 0) {
			rc = da9313_config_interface(REG06_MAX77938_ADDRESS, REG04_MAX77938_PVC_MODE_AUTO,
						     REG04_MAX77938_PVC_MODE_MASK);
		} else {
			rc = da9313_config_interface(REG06_MAX77938_ADDRESS, REG04_MAX77938_PVC_MODE_FIXED,
						     REG04_MAX77938_PVC_MODE_MASK);
		}
		break;
	case HWID_SD77313:
		if (work_mode != 0) {
			rc = da9313_config_interface(REG04_DA9313_ADDRESS, REG04_SD77313_PVC_MODE_AUTO,
						     REG04_SD77313_PVC_MODE_MASK);
		} else {
			rc = da9313_config_interface(REG04_DA9313_ADDRESS, REG04_SD77313_PVC_MODE_FIXED,
						     REG04_SD77313_PVC_MODE_MASK);
		}
		break;
	default:
...
static int get_hwid(struct chip_da9313 *chip)
{
	...
	if (IS_ERR_OR_NULL(chip->pinctrl) || IS_ERR_OR_NULL(chip->da9313_hwid_active) ||
	    IS_ERR_OR_NULL(chip->da9313_hwid_sleep) || IS_ERR_OR_NULL(chip->da9313_hwid_default)) {
