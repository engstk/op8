...
extern struct device_hcd * syna_td4330_remote_device_init(struct syna_tcm_hcd *tcm_hcd);
extern int syna_td4330_remote_device_destory(struct syna_tcm_hcd *tcm_hcd);
...
inline int syna_tcm_td4330_rmi_read(struct syna_tcm_hcd *tcm_hcd,
...
inline int syna_tcm_td4330_rmi_write(struct syna_tcm_hcd *tcm_hcd,
        unsigned short addr, unsigned char *data, unsigned int length)
{
    int    retval = 0;
    unsigned short tmp_addr = tcm_hcd->client->addr;
...
extern int td4330_try_to_recovery_ic(struct syna_tcm_hcd *tcm_hcd, char *iHex);
...
static fw_update_state syna_tcm_fw_update(void *chip_data, const struct firmware *fw, bool force)
{
    ...
    if (force) {
        ret = td4330_try_to_recovery_ic(tcm_hcd, tcm_hcd->iHex_name);
...
static int syna_tcm_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    device_hcd = syna_td4330_remote_device_init(tcm_hcd);
    if (device_hcd) {
