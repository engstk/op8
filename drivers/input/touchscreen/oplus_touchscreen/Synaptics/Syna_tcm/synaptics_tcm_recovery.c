...
static int recovery_device_reset(struct recovery_hcd *recovery_hcd)
{
    ...
    retval = syna_tcm_td4330_rmi_write(recovery_hcd->tcm_hcd,
...
static int recovery_check_status(struct recovery_hcd *recovery_hcd)
{
    ...
    retval = syna_tcm_td4330_rmi_read(recovery_hcd->tcm_hcd,
...
int td4330_try_to_recovery_ic(struct syna_tcm_hcd *tcm_hcd, char *iHex)
{
    int retval = 0;
